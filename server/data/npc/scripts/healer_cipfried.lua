...
local healthyMessage = "You aren't looking really bad, |PLAYERNAME|. I can only help in cases of real emergencies. Raise your health simply by eating food."
...
local function tryHealPlayer(cid)
	...
	elseif getCreatureHealth(cid) < 65 then
		...
		npcHandler:say(npcHandler:parseMessage(healthyMessage, {[TAG_PLAYERNAME] = getCreatureName(cid)}), cid)
	end
end
