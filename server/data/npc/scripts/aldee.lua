...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") and state == 1 and getPlayerItemCount(cid, 2559) >= 1 then
	...
	elseif msgcontains(msg, "yes") and state == 1 and getPlayerItemCount(cid, 2559) == 0 then
