...
function creatureSayCallback(cid, messageType, msg)
	...
	elseif msgcontains(msg, "yes") and state == 1 and getPlayerItemCount(cid, 2563) >= 1 then
	...
	elseif msgcontains(msg, "yes") and state == 1 and getPlayerItemCount(cid, 2563) == 0 then
