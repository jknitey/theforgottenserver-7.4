...
local routes = {
	["carlin"] = {
		...
		level = 8,
		premium = true,
		destination = {x = 32388, y = 31821, z = 6}
	},
	["ab'dendriel"] = {
		name = "Ab'Dendriel",
		cost = 0,
		level = 8,
		premium = true,
		destination = {x = 32734, y = 31669, z = 7}
	},
	["venore"] = {
		name = "Venore",
		cost = 0,
		level = 8,
		premium = true,
		destination = {x = 32954, y = 32022, z = 7}
	},
	["port hope"] = {
		name = "Port Hope",
		cost = 0,
		level = 8,
		premium = true,
		destination = {x = 32530, y = 32784, z = 6}
	},
	["edron"] = {
		name = "Edron",
		cost = 0,
		level = 8,
		premium = true,
		destination = {x = 33176, y = 31764, z = 7}
	},
}
...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "destination") or msgcontains(msg, "destinations") or msgcontains(msg, "sail") or msgcontains(msg, "passage") or msgcontains(msg, "trip") or msgcontains(msg, "route") or msgcontains(msg, "go") then
		npcHandler:say("Where do you want to go? To Carlin, Ab'Dendriel, Venore, Port Hope or Edron?", cid)
		return true
	end
