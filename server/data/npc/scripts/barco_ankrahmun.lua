...
local DestinationText = 'I can take you to {Venore}, {Gengia}, {Edron}, {Darashia} and {Port Hope}.'            
local CitysText = 'I can take you to {Venore}, {Edron}, {Gengia}, {Darashia} and {Port Hope}.'  
...
---------------------------------------CARLIN CONFIG---------------------------------------------- 
local CarlinPosition = getTownTravelPosition('Carlin', {x=32388, y=31821, z=6})              ----> Destination from Carlin Boat <---- 
...
---------------------------------------AB'DENDRIEL CONFIG----------------------------------------- 
local AbDendrielPosition = getTownTravelPosition("Ab'Dendriel", {x=32734, y=31669, z=6})     ----> Destination from Ab'Dendriel Boat <---- 
...
---------------------------------------VENORE CONFIG---------------------------------------------- 
local VenorePosition = getTownTravelPosition('Venore', {x=32954, y=32022, z=7})              ----> Destination from Venore Boat <---- 
...
---------------------------------------THAIS CONFIG----------------------------------------------- 
local ThaisPosition = getTownTravelPosition('Thais', {x=32310, y=32210, z=7})                ----> Destination from Thais Boat <---- 
...
---------------------------------------EDRON CONFIG----------------------------------------------- 
local EdronPosition = getTownTravelPosition('Edron', {x=33176, y=31764, z=7})                ----> Destination from Edron Boat <---- 
...
---------------------------------------DARASHIA CONFIG-------------------------------------------- 
local DarashiaPosition = getTownTravelPosition('Darashia', {x=33290, y=32481, z=7})          ----> Destination from Darashia Boat <---- 
...
---------------------------------------PORT HOPE CONFIG------------------------------------------- 
local PortHopePosition = getTownTravelPosition('Port Hope', {x=32530, y=32784, z=6})         ----> Destination from Port Hope Boat <---- 
...
---------------------------------------ANKRAHMUN CONFIG------------------------------------------- 
local AnkPosition = getTownTravelPosition('Ankrahmun', {x=33092, y=32884, z=7})              ----> Destination from Ankrahmun Boat <---- 
