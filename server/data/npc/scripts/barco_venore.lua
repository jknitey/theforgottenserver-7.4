...
local routes = {
	...
	["port hope"] = {name = "Port Hope", cost = 0, level = 8, premium = true, destination = {x = 32530, y = 32784, z = 6}},
...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "destination") or msgcontains(msg, "destinations") or msgcontains(msg, "sail") or msgcontains(msg, "passage") or msgcontains(msg, "trip") or msgcontains(msg, "route") or msgcontains(msg, "go") then
		npcHandler:say("Where do you want to go? To Thais, Carlin, Ab'Dendriel, Port Hope, Edron, Darashia or Ankrahmun?", cid)
		return true
	end
